import a from"/img/bVMBEQ";import n from"/img/bVMBEN";import p from"/img/bVMBEU";import{_ as e,o as l,c as t,a2 as i}from"./chunks/framework.BWuWLRhz.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/legacy/Vue系列/webpack压缩打包vue2项目（3）.md","filePath":"wiki/legacy/Vue系列/webpack压缩打包vue2项目（3）.md"}'),o={name:"wiki/legacy/Vue系列/webpack压缩打包vue2项目（3）.md"};function c(r,s,d,u,g,h){return l(),t("div",null,[...s[0]||(s[0]=[i('<p>学习vue的第三篇，增加了以下功能：</p><p>1、添加打包功能；</p><p>2、分离css和js；</p><p>3、增加vue-devtools；</p><p>4、增加歌曲列表组件。</p><p>这次更新做的事情不多，主要是发布的操作和vue开发工具的管理。</p><p>打包运行效果：<a href="https://hyy1115.github.io/blog/" target="_blank" rel="noreferrer">vue-酷我demo</a><img src="'+a+`" alt="图片描述"></p><h3 id="_1、添加打包功能" tabindex="-1"><strong>1、添加打包功能</strong> <a class="header-anchor" href="#_1、添加打包功能" aria-label="Permalink to &quot;**1、添加打包功能**&quot;">​</a></h3><p>webpack打包项目只需要配置package.json，通过命令运行，有的人喜欢用Python文件来执行打包命令。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&quot;scripts&quot;: {</span></span>
...
<span class="line"><span>    })</span></span>
<span class="line"><span>)</span></span></code></pre></div><p>官方说了一种提取css的方法，vue-loader集成了css提取模块，详情前往：<a href="http://vue-loader.vuejs.org/en/configurations/extract-css.html" target="_blank" rel="noreferrer">http://vue-loader.vuejs.org/en/configurations/extract-css.html</a></p><h3 id="_3、增加vue-tools" tabindex="-1"><strong>3、增加vue-tools</strong> <a class="header-anchor" href="#_3、增加vue-tools" aria-label="Permalink to &quot;**3、增加vue-tools**&quot;">​</a></h3><p>推荐直接去<a href="https://chrome.google.com/webstore/search/vue-devtools?utm_source=chrome-ntp-icon" target="_blank" rel="noreferrer">chrome应用商店安装</a></p><p><img src="`+p+`" alt="图片描述"></p><p>安装好之后，别着急，在地址栏输入：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>chrome://flags/</span></span></code></pre></div><p>找到下面这个东西，选择启用，变成下面这种状态。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
