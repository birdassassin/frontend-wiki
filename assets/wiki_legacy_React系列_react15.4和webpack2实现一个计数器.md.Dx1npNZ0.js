import n from"/img/bVLr38";import{_ as a,o as p,c as e,a2 as t}from"./chunks/framework.BWuWLRhz.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/legacy/React系列/react15.4和webpack2实现一个计数器.md","filePath":"wiki/legacy/React系列/react15.4和webpack2实现一个计数器.md"}'),l={name:"wiki/legacy/React系列/react15.4和webpack2实现一个计数器.md"};function c(o,s,i,r,u,d){return p(),e("div",null,[...s[0]||(s[0]=[t('<p>作为一个redux狂热爱好者，我还是第一次尝试剥离redux框架来搭建react项目，我喜欢用最新的版本来研究，比如react15，webpack2，等到react16出来，恐怕大家又得重新适应一些规则了。</p><p>学习前端以来，我发现前端框架变化太快，如果不保持持续性的学习能力，很容易就会被新人给替代。</p><p>这只是一个小玩意，展示了react和webpack2的基本框架搭建，没有redux，没有mobx，你可以纯粹当做学习如何搭建一个简单的react和webpack2框架，或者用来扩展成一个可管理的项目。</p><p>当然，在企业项目中，还是推荐用redux或者mobx来管理state。</p><p><img src="'+n+`" alt="图片描述"></p><p>看一下主要的代码。</p><p><strong>1、package.json：插件管理，没有配置build，只配置了start启动项目。</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{</span></span>
