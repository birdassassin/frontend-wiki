import{_ as l,o as t,c as e,a2 as n,j as a,a as i,t as c}from"./chunks/framework.BWuWLRhz.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/legacy/Vue系列/vue2条件渲染、列表渲染、事件处理器实现（4）.md","filePath":"wiki/legacy/Vue系列/vue2条件渲染、列表渲染、事件处理器实现（4）.md"}'),o={name:"wiki/legacy/Vue系列/vue2条件渲染、列表渲染、事件处理器实现（4）.md"};function r(p,s,g,d,u,m){return t(),e("div",null,[s[1]||(s[1]=n(`<p>学习vue2的过程中，我基本是按照vue2官网的教程走，并且主要以实现需求为主，如果不需要深入vue2的概念，就用简单的方法去实现。 本章实现了以下功能： 1、列表渲染，v-for； 2、条件渲染，v-if； 3、自适应布局； 4、事件处理器，v-on:click； 5、data数据管理。</p><p>运行效果：<a href="https://hyy1115.github.io/blog/" target="_blank" rel="noreferrer">vue-酷我demo</a><img src="https://gitee.com/birdassassin/frontend-wiki/raw/master/img/bVMG28" alt="图片描述"></p><h3 id="_1、列表渲染-v-for" tabindex="-1"><strong>1、列表渲染，v-for；</strong> <a class="header-anchor" href="#_1、列表渲染-v-for" aria-label="Permalink to &quot;**1、列表渲染，v-for；**&quot;">​</a></h3><p>在前面几章已经使用过几次v-for指令了，对此并不陌生，这次更新实现了排行榜列表和歌手列表，以排行榜列表为例，重温一下v-for的用法。</p><p><strong>Bang.vue：排行榜父组件</strong>，bangList是一个数组，for in遍历出来的是一个值属性，根据MDN文档对于for in遍历的解释，通常for in用来遍历对象Object。我们需要给遍历对象指定一个key，然后把遍历出来的属性list传递给子组件。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div>`,6)),a("p",null,[s[0]||(s[0]=a("strong",null,"BangList：排行榜列表子组件，",-1)),i(" 子组件是一个li，因为li是可点击的路由，所以使用router-link包裹，:to是绑定路由地址，然后img绑定了图片路径，在dom标签中输出使用双大括号"+c(p.list.title)+"，而export default是指默认导出的js代码，props表示获取从父组件传递过来的参数，至于参数验证，以后再添加。",1)]),s[2]||(s[2]=n(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
