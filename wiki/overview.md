...
本知识库采用 **Karpathy Wiki 方法**：原始材料经过系统化整理，提炼为高压缩比的概念页面、技术页面和模式页面。[`wiki/overview.md`](wiki/overview.md) 是最高压缩的综合概述；[`wiki/index.md`](wiki/index.md) 是完整目录。

> [!IMPORTANT]
> 从 [`wiki/overview.md`](wiki/overview.md) 开始，而不是直接跳到细节。概述提供了全局视角；索引提供了完整导航。
...
| 我想… | 从这里开始 |
|---|---|
| 了解全貌 | [wiki/overview.md](wiki/overview.md) |
| 浏览完整目录 | [wiki/index.md](wiki/index.md) |
| 掌握核心基础 | [concepts/html-fundamentals.md](wiki/concepts/html-fundamentals.md) · [concepts/css-fundamentals.md](wiki/concepts/css-fundamentals.md) · [concepts/javascript-fundamentals.md](wiki/concepts/javascript-fundamentals.md) |
| 理解现代框架 | [concepts/component-architecture.md](wiki/concepts/component-architecture.md) |
| 学习性能优化 | [concepts/web-vitals.md](wiki/concepts/web-vitals.md) |
| 掌握工程化 | [concepts/frontend-tooling.md](wiki/concepts/frontend-tooling.md) |
