...
<span class="line"><span>        )</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>我发现很多前端工程师的代码格式乱七八糟，在这里也告诉那些代码格式混乱的同学，平时写代码要注意大小写，该空格的空格，该换行的换行，具体可以看看我上面写的几个组件的例子，好的代码习惯会让代码维护变得更加简单。</p>`,14)])])}const m=a(t,[["render",l]]);export{_ as __pageData,m as default};
