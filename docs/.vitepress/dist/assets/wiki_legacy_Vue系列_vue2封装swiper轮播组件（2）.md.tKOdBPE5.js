...
<span class="line"><span>Prop 验证</span></span></code></pre></div><p>简单来说就是通过props实现父组件的数据流向子组件。</p><p><img src="https://gitee.com/birdassassin/frontend-wiki/raw/master/img/bVMwMh" alt="clipboard.png"></p><p>为什么叫做单向数据流呢？ 数据在父组件中可以修改，比如通过http请求动态更新数据，而子组件只负责通过props接收数据，子组件的权限是只读（如果我没理解错的话，那么跟react中是一样的。）</p><p>在本例子中，我实现了这样一个父组件Home.vue</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
<span class="line"><span>  &lt;div&gt;</span></span>
<span class="line"><span>   &lt;app-banner :listImg=&quot;listImg&quot;&gt;&lt;/app-banner&gt;</span></span>
<span class="line"><span>  &lt;/div&gt;</span></span>
<span class="line"><span>&lt;/template&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&lt;script&gt;</span></span>
<span class="line"><span> import Banner from &#39;./templates/Banner.vue&#39;</span></span>
<span class="line"><span> import a from &#39;../../static/img/home/banner1.png&#39;</span></span>
<span class="line"><span> import b from &#39;../../static/img/home/banner2.jpg&#39;</span></span>
<span class="line"><span> import c from &#39;../../static/img/home/banner3.jpg&#39;</span></span>
<span class="line"><span> import d from &#39;../../static/img/home/banner4.jpg&#39;</span></span>
<span class="line"><span> import e from &#39;../../static/img/home/banner5.jpg&#39;</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><h4 id="第四步-写css样式。" tabindex="-1">第四步：写css样式。 <a class="header-anchor" href="#第四步-写css样式。" aria-label="Permalink to &quot;第四步：写css样式。&quot;">​</a></h4><p>===================================== 分割线 =============================================</p><p>最后，到这一步已经完成了一个轮播图组件了。swiper还是挺好用的。贴上完整的Banner.vue代码，一字不差。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
<span class="line"><span>    &lt;div class=&quot;swiper-container&quot;&gt;</span></span>
<span class="line"><span>        &lt;div class=&quot;swiper-wrapper&quot;&gt;</span></span>
<span class="line"><span>            &lt;div class=&quot;swiper-slide&quot; v-for=&quot;str in listImg&quot; :style=&quot;{ backgroundImage: &#39;url(&#39; + str.url + &#39;)&#39; }&quot;&gt;&lt;/div&gt;</span></span>
<span class="line"><span>        &lt;/div&gt;</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>&lt;/style&gt;</span></span></code></pre></div><p>总结：vue的轮播实现并不难，整体过程和react中很相似，途中我也遇到一个小bug，图片路径一直报错，最后我发现图片后缀不对，第一张是banner1.png，后面4张都是bannerx.jpg，图片都是从酷狗下载的，一下子没注意，被这个坑了一下。</p><p>运行效果：[vue-酷我demo][1] ![图片描述][2]</p><p>项目地址：<a href="https://github.com/hyy1115/vue2-web" target="_blank" rel="noreferrer">https://github.com/hyy1115/vue2-web</a></p><p>上一章：[react转vue——vue2-webpack2框架搭建之路（1）][4]</p><p>下一章：[react转vue——webpack压缩打包vue项目（3）][5]</p><p><strong>如果文章对你有帮助，请点击一下推荐。</strong> [1]: <a href="https://hyy1115.github.io/blog/" target="_blank" rel="noreferrer">https://hyy1115.github.io/blog/</a> [2]: /img/bVMw0u [3]: <a href="http://www.swiper.com.cn/api/index.html" target="_blank" rel="noreferrer">http://www.swiper.com.cn/api/index.html</a> [4]: <a href="https://segmentfault.com/a/1190000009127162" target="_blank" rel="noreferrer">https://segmentfault.com/a/1190000009127162</a> [5]: <a href="https://segmentfault.com/a/1190000009162193" target="_blank" rel="noreferrer">https://segmentfault.com/a/1190000009162193</a></p>`,37)])])}const m=n(l,[["render",i]]);export{d as __pageData,m as default};
