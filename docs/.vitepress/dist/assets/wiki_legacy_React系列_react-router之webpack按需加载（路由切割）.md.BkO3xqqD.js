...
<span class="line"><span>&lt;script src=&quot;app.js&quot;&gt;&lt;/script&gt;</span></span></code></pre></div><p>5、好了，现在开发完了，准备打包成静态文件。输入<strong>npm run build</strong>刷刷刷的图片、js打包出来了。看一个打包效果图。 <img src="`+s+'" alt="图片描述"></p><p>6、要发布了？no，你需要学会服务端渲染，不送。。</p>',19)])])}const b=a(l,[["render",o]]);export{h as __pageData,b as default};
