import{_ as s,o as p,c as n,a2 as e}from"./chunks/framework.BWuWLRhz.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/legacy/React系列/你好，react，nice too me you!.md","filePath":"wiki/legacy/React系列/你好，react，nice too me you!.md"}'),t={name:"wiki/legacy/React系列/你好，react，nice too me you!.md"};function l(i,a,r,o,c,m){return p(),n("div",null,[...a[0]||(a[0]=[e(`<h4 id="引言" tabindex="-1">引言 <a class="header-anchor" href="#引言" aria-label="Permalink to &quot;引言&quot;">​</a></h4><p>常常有人问我，react如何学起？</p><p>我一般会告诉他，github上找个demo下载到本地运行，再结合网上的一些教程看代码。</p><p>但那些大部分是react技术栈的demo，无法让你更简单的理解react的组件化思想。</p><p>首先推荐一个在线运行react的网站，这也是dan大神推荐的 <a href="http://codepen.io/gaearon/pen/ZpvBNJ?editors=0010" target="_blank" rel="noreferrer">http://codepen.io/gaearon/pen/ZpvBNJ?editors=0010</a>，在该网站上面，你可以写任意的react代码，实时显示出来渲染结果。</p><p>用react做开发，可以分2大点：</p><p>1、react技术栈框架搭建；</p><p>2、react编程思想。</p><p>技术栈搭建即使对于有一定react开发经验的人来说，都有一些困难，我们先了解react编程思想中组件的实现。现在请你打开 <a href="http://codepen.io/gaearon/pen/ZpvBNJ?editors=0010" target="_blank" rel="noreferrer">http://codepen.io/gaearon/pen/ZpvBNJ?editors=0010</a>，跟着我写react代码。</p><h4 id="hello-world-react" tabindex="-1">hello world react <a class="header-anchor" href="#hello-world-react" aria-label="Permalink to &quot;hello world react&quot;">​</a></h4><p>react很多实践是SPA应用，而SPA通常只有一个入口，ReactDOM.render()会把组件或者jsx渲染在根元素“root”下，比如这个例子中会在root下面渲染 &lt;h1&gt;Hello, world!&lt;/h1&gt;</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>ReactDOM.render(</span></span>
<span class="line"><span>  &amp;amp;amp;lt;h1&amp;amp;amp;gt;Hello, world!&amp;amp;amp;lt;/h1&amp;amp;amp;gt;,</span></span>
<span class="line"><span>  document.getElementById(&amp;amp;amp;#039;root&amp;amp;amp;#039;)</span></span>
<span class="line"><span>);</span></span></code></pre></div><p><img src="https://gitee.com/birdassassin/frontend-wiki/raw/master/img/bVNtQ3" alt="clipboard.png"></p><h4 id="app根组件" tabindex="-1">App根组件 <a class="header-anchor" href="#app根组件" aria-label="Permalink to &quot;App根组件&quot;">​</a></h4><p>我们把 &lt;h1&gt;Hello, world!&lt;/h1&gt; 用react组件的形式来写，这里也提到了props的用法，用来从父组件传递属性给子组件。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>class App extends React.Component {</span></span>
...
<span class="line"><span>        &amp;amp;amp;lt;Forms value={this.state.value}&amp;amp;amp;gt;</span></span>
<span class="line"><span>          &amp;amp;amp;lt;input type=&amp;amp;amp;quot;text&amp;amp;amp;quot; onChange={(e) =&amp;amp;amp;gt; this.handleClick(e)} /&amp;amp;amp;gt;</span></span>
<span class="line"><span>        &amp;amp;amp;lt;/Forms&amp;amp;amp;gt;</span></span>
<span class="line"><span>      &amp;amp;amp;lt;/div&amp;amp;amp;gt;</span></span>
<span class="line"><span>    )</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span>
