import{_ as s,o as p,c as n,a2 as e}from"./chunks/framework.BWuWLRhz.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/legacy/前端系列/推荐几个github上超级star的异步插件.md","filePath":"wiki/legacy/前端系列/推荐几个github上超级star的异步插件.md"}'),t={name:"wiki/legacy/前端系列/推荐几个github上超级star的异步插件.md"};function i(r,a,l,o,c,m){return p(),n("div",null,[...a[0]||(a[0]=[e(`<p>如果你还在为选择哪个异步插件烦恼，不如静下心来看看下面这几个插件，或许会给你带来一些灵感。</p><p>1、request：<a href="https://github.com/request/request" target="_blank" rel="noreferrer">https://github.com/request/request</a>（10K+ star）</p><p>原作者自认为这个插件是设计的最最最简单的异步操作，例如这个例子，并且默认支持https，如果看到这种写法觉得很好用，赶紧点击链接去看看吧。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>var request = require(&amp;amp;#039;request&amp;amp;#039;);</span></span>
