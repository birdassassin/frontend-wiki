...
<span class="line"><span>  &amp;amp;amp;quot;presets&amp;amp;amp;quot;: [&amp;amp;amp;quot;es2015&amp;amp;amp;quot;, &amp;amp;amp;quot;flow-vue&amp;amp;amp;quot;, &amp;amp;amp;quot;stage-0&amp;amp;amp;quot;, &amp;amp;amp;quot;stage-2&amp;amp;amp;quot;],</span></span>
<span class="line"><span>  &amp;amp;amp;quot;plugins&amp;amp;amp;quot;: [&amp;amp;amp;quot;transform-vue-jsx&amp;amp;amp;quot;],</span></span>
<span class="line"><span>  &amp;amp;amp;quot;comments&amp;amp;amp;quot;: false,</span></span>
<span class="line"><span>  &amp;amp;amp;quot;env&amp;amp;amp;quot;: {</span></span>
<span class="line"><span>    &amp;amp;amp;quot;production&amp;amp;amp;quot;: {</span></span>
<span class="line"><span>      &amp;amp;amp;quot;plugins&amp;amp;amp;quot;: [</span></span>
<span class="line"><span>        [&amp;amp;amp;quot;transform-runtime&amp;amp;amp;quot;, { &amp;amp;amp;quot;polyfill&amp;amp;amp;quot;: false, &amp;amp;amp;quot;regenerator&amp;amp;amp;quot;: false }]</span></span>
<span class="line"><span>      ]</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="_7、在package-json添加start命令" tabindex="-1"><strong>7、在package.json添加start命令</strong> <a class="header-anchor" href="#_7、在package-json添加start命令" aria-label="Permalink to &quot;**7、在package.json添加start命令**&quot;">​</a></h3><p>直接使用webpack-dev-server启动，哇塞，一堆报错，说少了哪个module，这个简单，因为配置文件里面引用的一堆module，还没有安装到项目呢，这时候一个个安装好就行了。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&amp;amp;amp;quot;start&amp;amp;amp;quot;: &amp;amp;amp;quot;webpack-dev-server&amp;amp;amp;quot;,</span></span></code></pre></div><h3 id="_8、项目入口main-js文件。" tabindex="-1"><strong>8、项目入口main.js文件。</strong> <a class="header-anchor" href="#_8、项目入口main-js文件。" aria-label="Permalink to &quot;**8、项目入口main.js文件。**&quot;">​</a></h3><p>这个文件名自己喜欢咋取就咋取，代码挺简单的，实例化一个Vue和路由，是不是和react的入口文件很像？当然，我做的是SPA，所以采用单入口的形式，如果是非SPA模式，就不是这种配置方式了。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import Vue from &amp;amp;amp;#039;vue&amp;amp;amp;#039;;</span></span>
<span class="line"><span>import App from &amp;amp;amp;#039;./App.vue&amp;amp;amp;#039;;</span></span>
<span class="line"><span>import VueRouter from &amp;amp;amp;#039;vue-router&amp;amp;amp;#039;;</span></span>
<span class="line"><span>import routes from &amp;amp;amp;#039;./routes&amp;amp;amp;#039;;</span></span>
<span class="line"><span>import VueResource from &amp;amp;amp;#039;vue-resource&amp;amp;amp;#039;;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    // mode: &amp;amp;amp;#039;history&amp;amp;amp;#039;,</span><span> //H5 路由模式，需要服务端做渲染防止404错误</span></span>
<span class="line"><span>    base: __dirname,</span></span>
<span class="line"><span>    linkActiveClass: &amp;amp;amp;#039;on&amp;amp;amp;#039;,</span></span>
<span class="line"><span>    routes</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span></span></span>
<span class="line"><span>let render = new Vue({</span></span>
<span class="line"><span>    router,</span></span>
<span class="line"><span>    el: &amp;amp;amp;#039;#app&amp;amp;amp;#039;,</span></span>
<span class="line"><span>    render: h =&amp;amp;amp;gt; h(App)</span></span>
<span class="line"><span>});</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>//     module.hot.accept(&amp;amp;amp;#039;./App.vue&amp;amp;amp;#039;, () =&amp;amp;amp;gt; render);</span></span>
<span class="line"><span>// }</span></span></code></pre></div><h3 id="_9、路由routes-js" tabindex="-1"><strong>9、路由routes.js</strong> <a class="header-anchor" href="#_9、路由routes-js" aria-label="Permalink to &quot;**9、路由routes.js**&quot;">​</a></h3><p>路由和react也非常像（简直一样好不），这里的vue页面采用.vue后缀的方式来写。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import Home from &amp;amp;amp;#039;./components/home/Home.vue&amp;amp;amp;#039;;</span></span>
<span class="line"><span>import Bang from &amp;amp;amp;#039;./components/bang/Bang.vue&amp;amp;amp;#039;;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>export default [</span></span>
<span class="line"><span>    {</span></span>
<span class="line"><span>        path: &amp;amp;amp;#039;/&amp;amp;amp;#039;,</span></span>
<span class="line"><span>        redirect: &amp;amp;amp;#039;home&amp;amp;amp;#039;</span></span>
<span class="line"><span>    },</span></span>
<span class="line"><span>    {</span></span>
<span class="line"><span>        path: &amp;amp;amp;#039;/home&amp;amp;amp;#039;,</span></span>
<span class="line"><span>        component: Home</span></span>
<span class="line"><span>    },</span></span>
<span class="line"><span>    {</span></span>
<span class="line"><span>        path: &amp;amp;amp;#039;/bang&amp;amp;amp;#039;,</span></span>
<span class="line"><span>        component: Bang</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>]</span></span></code></pre></div><h3 id="_10、单页顶层容器app-vue" tabindex="-1"><strong>10、单页顶层容器App.vue</strong> <a class="header-anchor" href="#_10、单页顶层容器app-vue" aria-label="Permalink to &quot;**10、单页顶层容器App.vue**&quot;">​</a></h3><p>从index进来，就是这个文件，现在开始学习vue的精华。</p><p>template：vue的模板语言，也叫作jsx。 transition：过渡动画。 router-view：路由显示容器，通过router-link跳转加载的.vue会在这个容器渲染。router-link被我封装到nav.vue组件里面了。 script：导入了当前顶级容器需要用到的vue组件，包括头部、导航、首页。还有更多丰富的设置我没有研究，后续的学习中会深入下去。 style: 当前组件的样式，我配置了less语法支持。将style改成&lt;style lang=&quot;less&quot;&gt;即可写less。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&amp;amp;amp;lt;template&amp;amp;amp;gt;</span></span>
<span class="line"><span>    &amp;amp;amp;lt;div&amp;amp;amp;gt;</span></span>
<span class="line"><span>        &amp;amp;amp;lt;app-header logo=&amp;amp;amp;quot;logo&amp;amp;amp;quot; &amp;amp;amp;gt;&amp;amp;amp;lt;/app-header&amp;amp;amp;gt;</span></span>
<span class="line"><span>        &amp;amp;amp;lt;app-nav&amp;amp;amp;gt;&amp;amp;amp;lt;/app-nav&amp;amp;amp;gt;</span></span>
<span class="line"><span>        &amp;amp;amp;lt;transition name=&amp;amp;amp;quot;fade&amp;amp;amp;quot; mode=&amp;amp;amp;quot;out-in&amp;amp;amp;quot;&amp;amp;amp;gt;</span></span>
<span class="line"><span>            &amp;amp;amp;lt;router-view class=&amp;amp;amp;quot;view&amp;amp;amp;quot;&amp;amp;amp;gt;&amp;amp;amp;lt;/router-view&amp;amp;amp;gt;</span></span>
<span class="line"><span>        &amp;amp;amp;lt;/transition&amp;amp;amp;gt;</span></span>
<span class="line"><span>    &amp;amp;amp;lt;/div&amp;amp;amp;gt;</span></span>
<span class="line"><span>&amp;amp;amp;lt;/template&amp;amp;amp;gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&amp;amp;amp;lt;script&amp;amp;amp;gt;</span></span>
<span class="line"><span>    import Header from &amp;amp;amp;#039;./components/common/Header.vue&amp;amp;amp;#039;;</span></span>
<span class="line"><span>    import Nav from &amp;amp;amp;#039;./components/common/Nav.vue&amp;amp;amp;#039;;</span></span>
<span class="line"><span>    import Home from &amp;amp;amp;#039;./components/home/Home.vue&amp;amp;amp;#039;;</span></span>
<span class="line"><span>    export default {</span></span>
<span class="line"><span>        name: &amp;amp;amp;#039;App&amp;amp;amp;#039;,</span></span>
<span class="line"><span>        components: {</span></span>
<span class="line"><span>            &amp;amp;amp;quot;app-header&amp;amp;amp;quot;: Header,</span></span>
<span class="line"><span>            &amp;amp;amp;quot;app-nav&amp;amp;amp;quot;: Nav,</span></span>
<span class="line"><span>            &amp;amp;amp;quot;app-home&amp;amp;amp;quot;: Home</span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>    };</span></span>
<span class="line"><span>&amp;amp;amp;lt;/script&amp;amp;amp;gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&amp;amp;amp;lt;style&amp;amp;amp;gt;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>&amp;amp;amp;lt;/style&amp;amp;amp;gt;</span></span></code></pre></div><p>踩坑的过程中，也遇到了好几个报错情况，最后都圆满解决了。 如果你想看更详细的vue组件代码，可以看具体项目：[<a href="https://github.com/hyy1115/vue2-web" target="_blank" rel="noreferrer">https://github.com/hyy1115/vue2-web</a>][5]</p><p>接下来我会继续完善该项目，探究一个更加灵活的vue架构实现。</p><h3 id="运行效果图-vue-酷我demo-1" tabindex="-1">运行效果图:[vue-酷我demo][1] <a class="header-anchor" href="#运行效果图-vue-酷我demo-1" aria-label="Permalink to &quot;运行效果图:[vue-酷我demo][1]&quot;">​</a></h3><p>![效果图][2]</p><p>下一章：[vue2封装swiper轮播组件（2）][6]</p><p><strong>如果文章对你有帮助，请点击一下推荐。</strong> [1]: <a href="https://hyy1115.github.io/blog/" target="_blank" rel="noreferrer">https://hyy1115.github.io/blog/</a> [2]: <a href="https://gitee.com/birdassassin/frontend-wiki/raw/master/img/bVMsyF" target="_blank" rel="noreferrer">https://gitee.com/birdassassin/frontend-wiki/raw/master/img/bVMsyF</a> [3]: <a href="https://cn.vuejs.org/v2/guide/installation.html" target="_blank" rel="noreferrer">https://cn.vuejs.org/v2/guide/installation.html</a> [4]: <a href="http://elemefe.github.io/cooking/" target="_blank" rel="noreferrer">http://elemefe.github.io/cooking/</a> [5]: <a href="https://github.com/hyy1115/vue2-web" target="_blank" rel="noreferrer">https://github.com/hyy1115/vue2-web</a> [6]: <a href="https://segmentfault.com/a/1190000009143923" target="_blank" rel="noreferrer">https://segmentfault.com/a/1190000009143923</a></p>`,45)])])}const d=p(m,[["render",t]]);export{h as __pageData,d as default};
